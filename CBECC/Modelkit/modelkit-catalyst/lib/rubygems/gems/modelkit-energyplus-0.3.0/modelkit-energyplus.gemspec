...
Gem::Specification.new do |spec|
  spec.name = "modelkit-energyplus"
  spec.version = version
  spec.metadata = {
    "build" => build,
    "homepage_uri" => "https://bigladdersoftware.com/projects/modelkit/",
    "source_code_uri" => "https://bitbucket.org/bigladder/modelkit-energyplus/src",
    "bug_tracker_uri" => "https://bitbucket.org/bigladder/modelkit-energyplus/issues?status=new&status=open"
  }

  spec.license = "BSD-3-Clause"
  spec.summary = "Modelkit for EnergyPlus extends the Modelkit framework to work with EnergyPlus."
  spec.description = "Modelkit for EnergyPlus extends the Modelkit framework to work with the EnergyPlus engine."
  ...
  spec.bindir = "bin"
  spec.executables = ["modelkit-energyplus"]

  spec.required_ruby_version = ">= 2.0.0"
  spec.add_runtime_dependency("modelkit", "~> 0.6")
