...
echo OFF
echo BEMCompiler16c.exe returned (%ERRORLEVEL%) for T24N_2019
if %ERRORLEVEL%==0 goto :copyfiles
goto :error
:copyfiles
copy "..\RulesetDev\Rulesets\T24N\T24N Screens.txt"  "..\CBECC-Com\Data\Rulesets\T24N_2019\T24N_2019 Screens.txt"
copy "..\RulesetDev\Rulesets\T24N\T24N ToolTips.txt" "..\CBECC-Com\Data\Rulesets\T24N_2019\T24N_2019 ToolTips.txt"
copy "..\RulesetDev\Rulesets\T24N\*.jpg" "..\CBECC-Com\Data\Rulesets\T24N_2019\*.*"
copy "..\RulesetDev\Rulesets\T24N\RTF\*.*" "..\CBECC-Com\Data\Rulesets\T24N_2019\RTF\*.*"
