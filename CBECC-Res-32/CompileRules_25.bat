echo off
  echo --------------------------------------------
  echo Compiling 2025 SFam ruleset (for CBECC-Res 32-bit)...
BEMCompiler25r.exe --sharedPath1="../RulesetSrc/shared/" --bemBaseTxt="../RulesetSrc/BEMBase-SFam.txt" --bemEnumsTxt="../RulesetSrc/T24SFam/CAR25 BEMEnums.txt" --bemBaseBin="Data/Rulesets/CA Res 2025/CAR25 BEMBase.bin" --rulesTxt="../RulesetSrc/T24SFam/Rules-2025-x86.txt" --rulesBin="Data/Rulesets/CA Res 2025.bin" --rulesLog="_Rules-SFam-2025-x86 Log.out" --compileDM --compileRules
...
:error2
  ...
  echo See log file for details:  _Rules-SFam-2025-x86 Log.out
  echo --------------------------------------------
  pause
:finalDone
