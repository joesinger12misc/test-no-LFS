...
BEMCompiler19r.exe --bemBaseTxt="../RulesetDev/Rulesets/CA Res/CAR13 BEMBase.txt" --bemEnumsTxt="../RulesetDev/Rulesets/CA Res/CAR19 BEMEnums.txt" --bemBaseBin="Data/Rulesets/CA Res 2019/CAR19 BEMBase.bin" --rulesTxt="../RulesetDev/Rulesets/CA Res/Rules/Rules-2019-2-0.txt" --rulesBin="Data/Rulesets/CA Res 2019.bin" --rulesLog="../RulesetDev/Rulesets/CA Res/Rules/Rules-2019 Log.out" --compileDM --compileRules
